...
def eval_model_performance(nr_results, model_results, path=None):
    ...
    :param nr_results: filename of the results from the nr verification file.
    :param model_results: filename of the file containing the model prediction data.
...
avg_output_performance = np.average(output_performance)
